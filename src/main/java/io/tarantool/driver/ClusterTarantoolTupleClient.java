...
public class ClusterTarantoolTupleClient
     ...
     * @see TarantoolCredentials
     */
    public ClusterTarantoolTupleClient(String host, int port) {
        this(new SimpleTarantoolCredentials(), Collections.singletonList(new TarantoolServerAddress(host, port)));
    }
     ...
     * @see TarantoolCredentials
     */
    public ClusterTarantoolTupleClient(TarantoolServerAddress address) {
        this(new SimpleTarantoolCredentials(), Collections.singletonList(address));
    }
     ...
     * @see TarantoolCredentials
     */
    public ClusterTarantoolTupleClient(List<TarantoolServerAddress> addressList) {
        this(new SimpleTarantoolCredentials(), addressList);
    }
    ...
    public static TarantoolClusterClientBuilder builder() {
        return TarantoolClusterClientBuilder.INSTANCE;
    }
