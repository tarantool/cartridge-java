 ...
 * @author Alexey Kuzin
 */
public class ArrayValueToMultiValueListConverter<T, R extends List<T>, V extends Value>
    implements ValueConverter<ArrayValue, R> {
     ...
     */
    public ArrayValueToMultiValueListConverter(ValueConverter<V, T> valueConverter, Supplier<R> containerSupplier) {
