 ...
 */
public class ClusterTarantoolResultMapper<T> implements MessagePackValueMapper {
     ...
     */
    public ClusterTarantoolResultMapper(MessagePackValueMapper valueMapper,
        ...
        valueMapper.registerValueConverter(ArrayValue.class, TarantoolResultImpl.class,
                v -> new TarantoolResultImpl<>(v, tupleConverter, true));
    }
